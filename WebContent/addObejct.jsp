...
<body>
	<div id = "location1">
	  <br>
	    <form action="user/insertNewObjectUser.do" method="post"  id="f">
	    		<span id= "style">新项目用户名称：</span>
	    		<input type = "text" name = "userName" id = "location"/><br>
	    		<span id= "style1">新项目登录密码：</span>
	    		<input type = "password" name = "pwd" id = "storpid"/>
	    		<input class = "button bg-main icon-check-square-o" type="submit"  value = "点击创建新项目空间" id= "sub">
	    </form>
	 </div>
