...
<body>
	<div id = "location1">
	  <br>
	    <form action="initImportC03TableController/chushiWuXiao.do" method="post"  id="f">
	    		...
	    		<input class = "button bg-main icon-check-square-o" type="submit"  value = "点击查询回款数据" id= "sub">
	    </form>
	 </div>
