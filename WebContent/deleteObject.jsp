...
<body>
	<div id = "location1">
	  <br>
	    <form action="user/deleteObjectUser.do" method="post"  id="f">
	    		<span id= "style">删除项目用户名称：</span>
	    		<input type = "text" name = "userName" id = "location"/><br>
	    		<span id= "style1">请输入密码确认删除：</span>
	    		<input type = "password" name = "pwd" id = "storpid"/>
	    		<input class = "button bg-main icon-check-square-o" type="submit"  value = "点击删除已创建的项目" id= "sub">
	    </form>
	 </div>
